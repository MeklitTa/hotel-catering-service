...
// placing user order from the fron end
...
const placeOrder = async (req, res) => {
  ...
  if (
    ...
    console.log("Invalid items data:", req.body.item);
    return res.json({ success: false, message: "No items in cart" });
  }

  if (!req.body.userId) {
    console.log("Missing userId:", req.body.userId);
